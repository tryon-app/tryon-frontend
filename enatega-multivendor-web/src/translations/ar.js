const ar = {
  translation: {
    ...
    orderSubText1:
      "استمتع براحة الحصول على جميع وجبات ومأكولات المطاعم المفضلة لديك في مكان واحد، مع توصيلها مباشرة إلى باب منزلك بسرعة وطازجة. قم بتنزيل تطبيق Tryon اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    orderSubText2:
      "استكشف مجموعة واسعة من الخيارات، من المفضلات المحلية والطعام المريح إلى الأطباق الراقية، الأطعمة الصحية والمزيد.",
    orderSubText3:
      "قم بتنزيل تطبيق Tryon اليوم، وحقق كل رغبة في تناول الطعام إلى حقيقة لذيذة.",
    ...
    vendorDescription:
      "وسع نطاق وصولك، واجذب المزيد من العملاء، وابنِ روابط أقوى في كل حي. انضم إلى Tryon كبائع اليوم!",
