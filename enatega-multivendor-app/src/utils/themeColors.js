export const theme = {
  Pink: {
    ...
    white: '#FFF',
    radioOuterColor: '#fff',
    filterRadioOuterColor: '#20979d',
    mustard: '#d8d8d874',
    borderColor: '#efefef',
    iconBackground: '#E5E7EB',
    newheaderColor: '#20979d',
